...
Star Wars and Harry Potter appear to have some of the largest sets, with noticeable peaks in piece count, indicating the release of large, complex builds. Super Heroes also shows significant growth in set sizes, particularly in the later years. Meanwhile, Lord of the Rings, Disney, and Town exhibit more stable or modest growth, suggesting that their sets tend to remain in a lower piece range. Super Mario, being a newer franchise, has smaller sets overall, reflecting its recent introduction into the LEGO lineup.
