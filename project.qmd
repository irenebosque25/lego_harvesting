...
#   # Usamos pmap() para aplicar la función a cada fila
#   mutate(product_data = pmap(list(category_url, n_pages, category_name), scrape_products)) %>%
#   # Extraemos los datos de 'product_data' y los combinamos en un solo tibble
#   select(product_data) %>%
